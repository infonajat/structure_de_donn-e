...
char catagories[][15]={"scientifique","historique","litterature","scolaire","dictionnaire","Dev.perso"};
...
gotoxy(20,11);
printf(" 4: Libere un livre");
gotoxy(20,13);
printf(" 5: Voir la liste des livres");
gotoxy(20,15);
printf(" 6: Modifier l'edition du livre");
gotoxy(20,17);
printf("7: Fermer l'application");
gotoxy(20,19);
printf("-----------------------------------------------------------------");
gotoxy(20,20);
...
int i;
gotoxy(20,3);
printf(":::::::::::::::::::::: Selectioner une categorie ::::::::::::::::::::::");
gotoxy(20,5);
printf(" 1: scientifiques");
gotoxy(20,7);
printf(" 2: historiques");
gotoxy(20,9);
printf(" 3: litterature");
gotoxy(20,11);
printf(" 4: scolaires");
gotoxy(20,13);
printf(" 5: dictionnaire");
gotoxy(20,15);
printf(" 6: Dev.perso");
gotoxy(20,17);
...
gotoxy(20,12);
printf(" Quantity:%d ",a.quantity);gotoxy(47,12);
gotoxy(20,13);
printf(" Price:Rs.%.2f",a.Price);gotoxy(47,13);
gotoxy(20,14);
printf(" Rack No:%d ",a.rackno);gotoxy(47,14);
gotoxy(20,15);
...
gotoxy(20,4);printf("\_______________________________________________________/");
gotoxy(20,5);
gotoxy(46,5);
gotoxy(20,6);
gotoxy(46,6);
...
{
gotoxy(15,16);
printf("\aIncorrect Password ,Please retry");
getch();
Password();
}
}
